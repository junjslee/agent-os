...
**Six failure modes ↔ counter artifacts.**
...
**Scope boundary.** See [KERNEL_LIMITS.md](./KERNEL_LIMITS.md) — the kernel is wrong tool for: trivial-cost decisions, disconfirmation paralysis, tacit-dominated work, multi-operator loops, unvalidated calibration claims.

**Attribution.** Every borrowed concept traced in [REFERENCES.md](./REFERENCES.md).

---

*Next load, in priority order:* [CONSTITUTION.md](./CONSTITUTION.md) · [REASONING_SURFACE.md](./REASONING_SURFACE.md) · [FAILURE_MODES.md](./FAILURE_MODES.md) · [KERNEL_LIMITS.md](./KERNEL_LIMITS.md) · [OPERATOR_PROFILE_SCHEMA.md](./OPERATOR_PROFILE_SCHEMA.md) · [REFERENCES.md](./REFERENCES.md).
