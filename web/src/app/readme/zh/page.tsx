...
function readReadmeZh(): string {
  const candidates = [
    path.join(/* turbopackIgnore: true */ process.cwd(), "..", "README.zh.md"),
    path.join(/* turbopackIgnore: true */ process.cwd(), "README.zh.md"),
  ];
  ...
  throw new Error(
    `README.zh.md not reachable. Tried: ${candidates.join(" · ")}. ` +
      `If deploying with web/ as the project root, copy README.zh.md into web/ at build time.`,
  );
}
...
export const metadata: Metadata = {
  title: "README (中文) — episteme",
  description:
    "README.md 中文版。为你已在用的 AI 编码代理提供的 Thinking Framework — Sovereign Cognitive Kernel。",
};

export default function ReadmeZhPage() {
  const markdown = readReadmeZh();
  return (
    <>
      <Header />
      <main className="mx-auto max-w-3xl px-6 py-16 md:py-24" lang="zh">
        <ReactMarkdown
